...
| LITELLM_MODEL_COST_MAP_URL | URL for fetching model cost map data. Default is https://raw.githubusercontent.com/opleonnn/litellm/main/model_prices_and_context_window.json
